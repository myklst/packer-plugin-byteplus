...
type FlatConfig struct {
	...
	Tags                      []FlatVolcengineEcsImageTag    `mapstructure:"tags" required:"false" cty:"tags" hcl:"tags"`
}
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"tags":                         &hcldec.BlockListSpec{TypeName: "tags", Nested: hcldec.ObjectSpec((*FlatVolcengineEcsImageTag)(nil).HCL2Spec())},
	}
	return s
}
...
// FlatVolcengineEcsImageTag is an auto-generated flat version of VolcengineEcsImageTag.
// Where the contents of a field with a `mapstructure:,squash` tag are bubbled up.
type FlatVolcengineEcsImageTag struct {
	Key   *string `mapstructure:"key" required:"true" cty:"key" hcl:"key"`
	Value *string `mapstructure:"value" required:"false" cty:"value" hcl:"value"`
}

// FlatMapstructure returns a new FlatVolcengineEcsImageTag.
// FlatVolcengineEcsImageTag is an auto-generated flat version of VolcengineEcsImageTag.
// Where the contents a fields with a `mapstructure:,squash` tag are bubbled up.
func (*VolcengineEcsImageTag) FlatMapstructure() interface{ HCL2Spec() map[string]hcldec.Spec } {
	return new(FlatVolcengineEcsImageTag)
}

// HCL2Spec returns the hcl spec of a VolcengineEcsImageTag.
// This spec is used by HCL to read the fields of VolcengineEcsImageTag.
// The decoded values from this spec will then be applied to a FlatVolcengineEcsImageTag.
func (*FlatVolcengineEcsImageTag) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
